definition(
    ...
    //parent: "lpalonzo:OneTap-Escenario",
...
preferences 
{
    page(name: "FrontPage", uninstall: false, nextPage: "Eventos" ) 
...
def FrontPage() 
{
    def version = "Version: 0.6"
    dynamicPage(name: "FrontPage") 
    {
        section()
        {
            image "http://blog.sharadaintl.com/wp-content/uploads/2016/11/cyborg_3-1.jpg"
            href(name: "intro", title: "OneTap-Escenario", description: version, required: false, image: "https://cdn.iconscout.com/public/images/icon/premium/png-128/smart-home-3a965e9b98c3a41c-128x128.png", 
            url: "http://m.uploadedit.com/ba3s/1488487145757.txt")
        }
        section("                                       by lpalonzo")
        {
        }
